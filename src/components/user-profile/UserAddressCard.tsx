    ...
    <>
      ...
      <div className="p-5 border border-gray-200 rounded-2xl dark:border-gray-800 lg:p-6">
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          ...
          <button
            onClick={openModal}
            className="flex w-full lg:w-auto items-center justify-center gap-2 rounded-full border border-gray-300 bg-white px-4 py-3 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-300"
          >
            {/* EDIT ICON (same style as your original cards) */}
            <svg
          ...
          <div className="grid grid-cols-1 gap-5">
            ...
            <div>
              ...
              <Input
                ...
                onChange={(e) =>
                  handleChange("residential_zone", e.target.value)
                }
              />
            </div>
