    ...
    <div className="fixed inset-0 z-50 bg-black/40 flex items-center justify-center p-4">
      ...
      <div className="bg-white rounded-2xl w-full max-w-lg p-6 text-gray-800 dark:bg-gray-900 dark:text-white/90">
        ...
        <textarea
          ...
          className="w-full border border-gray-200 bg-white rounded-xl p-3 text-gray-800 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-blue-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white/90 dark:placeholder:text-gray-500"
        />
        ...
        <div className="flex justify-end gap-3 mt-5">
          ...
          <button
            onClick={onClose}
            className="px-4 py-2 rounded-lg border border-gray-200 text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-white/[0.05]"
          >
            Ghairi
          </button>
